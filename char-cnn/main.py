...
save = True
model_name_path = 'save/model.json'
model_weights_path = 'save/model_weights.h5'
...
cat_output = 11 # consider only first 6 groups for now
...
#categories.
(xt, yt), (x_test, y_test) = data_helpers.load_data_1()
