...
\begin{table}
	...
	\end{tabular}
	\caption{Performance on test set evaluated via the metrics discussed above; hyperparameter settings for each model were selected via performance on the validation set.}
	\label{fig:eval}
\end{table}
